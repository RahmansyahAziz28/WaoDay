...
## Corpus Check
- 103 files · ~60,631 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1100 nodes · 1420 edges · 76 communities (66 shown, 10 thin omitted)
...
Cohesion: 0.05
Nodes (42): DateTime?, int get, RekapNilaiData, _berlakuSampai, BuatTokenUjianScreen, _BuatTokenUjianScreenState, build, createState (+34 more)
...
Cohesion: 0.40
Nodes (4): ../data/dummy_data.dart, build, _handleLogout, _handleRefresh
...
Cohesion: 0.04
Nodes (46): admin_sekolah.dart, auth_user.dart, game_token.dart, guru.dart, guru_dashboard.dart, kelas.dart, count, createdAt (+38 more)
...
Cohesion: 0.20
Nodes (9): auth_service.dart, dart:convert, GuruDashboardData, getDashboardData, GuruService, instance, ../models/auth_user.dart, ../models/guru_dashboard.dart (+1 more)
...
Cohesion: 0.18
Nodes (11): detail_kelas_screen.dart, _apiKelasList, createState, _errorMessage, _handleRefresh, initState, _isLoading, KelasSayaScreen (+3 more)

### Community 45 - "guru_dashboard_screen.dart"
Cohesion: 0.17
Nodes (12): daftar_siswa_screen.dart, createState, _errorMessage, _fetchDashboard, GuruDashboardScreen, _GuruDashboardScreenState, icon, initState (+4 more)
...
Cohesion: 0.13
Nodes (14): api_client.dart, ../config/api_config.dart, AdminSekolah, _admins, allAdmins, createAdmin, deleteAdmin, getAdminList (+6 more)

### Community 67 - "splash_screen.dart"
Cohesion: 0.18
...
Cohesion: 0.12
Nodes (17): build, createState, dispose, _errorMessage, _guruList, _handleDeleteKelas, _handleLogout, initState (+9 more)

### Community 70 - "StatefulWidget"
Cohesion: 0.67
...
Cohesion: 0.15
Nodes (12): dart:async, dart:io, createGameToken, GameTokenService, getMateri, getRekapNilai, _getToken, getTokensByKelas (+4 more)

### Community 76 - "superadmin_home.dart"
Cohesion: 0.12
Nodes (17): ../auth/login_screen.dart, build, _handleLogout, build, createState, _currentIndex, _filterSekolahIdForAdmin, _handleLogout (+9 more)

## Knowledge Gaps
- **680 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+675 more)
...
- **Why does `Kelas` connect `daftar_siswa_screen.dart` to `buat_token_ujian_screen.dart`, `guru.dart`, `kelas_service.dart`, `detail_kelas_screen.dart`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `RekapNilaiData` connect `buat_token_ujian_screen.dart` to `game_token_service.dart`, `game_token.dart`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
