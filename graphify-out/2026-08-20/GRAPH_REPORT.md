# Graph Report - waoday  (2026-08-20)

## Corpus Check
- 88 files · ~43,589 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 787 nodes · 999 edges · 63 communities (53 shown, 10 thin omitted)
...
Cohesion: 0.15
Nodes (12): build, createState, dispose, _emailController, _emailError, _errorMessage, _handleLogin, _isLoading (+4 more)
...
Cohesion: 0.18
Nodes (11): ../admin/admin_home.dart, ../guru/guru_home.dart, build, _checkAuth, createState, initState, routeName, SplashScreen (+3 more)
...
### Community 14 - "daftar_siswa_screen.dart"
Cohesion: 0.17
...
Cohesion: 0.29
Nodes (7): ProfilAdminScreen, _StatCard, ProfilGuruScreen, AppButton, AppInput, InfoRow, StatelessWidget
...
Cohesion: 0.20
Nodes (9): AkademikApp, build, main, screens/admin/admin_home.dart, screens/auth/forgot_password_screen.dart, screens/auth/login_screen.dart, screens/auth/register_screen.dart, screens/auth/splash_screen.dart (+1 more)
...
Cohesion: 0.50
Nodes (3): package:flutter_test/flutter_test.dart, package:waoday/main.dart, main
...
Cohesion: 0.14
Nodes (13): daftar_siswa_screen.dart, detail_kelas_screen.dart, build, createState, _errorMessage, _fetchDashboard, icon, initState (+5 more)

### Community 24 - "package:flutter/material.dart"
Cohesion: 0.20
Nodes (9): build, icon, label, value, build, LoadingState, message, package:flutter/material.dart (+1 more)

### Community 25 - "guru.dart"
Cohesion: 0.04
Nodes (44): auth_user.dart, guru.dart, guru_dashboard.dart, kelas.dart, createdAt, SekolahInfo, fromJson, Guru (+36 more)
...
Cohesion: 0.10
Nodes (20): ApiConfig, baseUrl, dashboardGuruEndpoint, dashboardGuruUri, guruDetailUri, guruUri, kelasDetailUri, kelasSiswaUri (+12 more)

### Community 34 - "admin_service.dart"
Cohesion: 0.12
Nodes (16): dart:async, AdminService, createGuru, createSekolah, deleteGuru, deleteSekolah, getGuruDetail, getGuruList (+8 more)

### Community 35 - "manajemen_sekolah_screen.dart"
Cohesion: 0.12
Nodes (16): build, createState, dispose, _errorMessage, _handleDeleteSekolah, initState, _isLoading, _loadSekolah (+8 more)

### Community 36 - "kelas_service.dart"
Cohesion: 0.12
Nodes (16): createKelas, createSiswa, deleteKelas, deleteSiswa, getKelas, getKelasDetail, getSiswaInKelas, _getToken (+8 more)

### Community 37 - "admin_dashboard_screen.dart"
Cohesion: 0.12
Nodes (17): AdminDashboardScreen, _AdminDashboardScreenState, build, _buildStatCard, createState, _errorMessage, _fetchDashboardData, _guruList (+9 more)

### Community 38 - "manajemen_guru_screen.dart"
Cohesion: 0.12
Nodes (17): build, createState, dispose, _errorMessage, _guruList, _handleDeleteGuru, initState, _isLoading (+9 more)

### Community 39 - "auth_service.dart"
Cohesion: 0.12
Nodes (15): AuthService, _clearSession, getToken, instance, _keyRefreshToken, _keyToken, _keyUser, login (+7 more)

### Community 40 - "admin_home.dart"
Cohesion: 0.18
Nodes (11): admin_dashboard_screen.dart, AdminHome, _AdminHomeState, build, createState, _index, _navigateToTab, routeName (+3 more)
...
Cohesion: 0.17
Nodes (11): auth_service.dart, ../config/api_config.dart, dart:convert, dart:io, GuruDashboardData, getDashboardData, GuruService, instance (+3 more)

### Community 43 - "guru_home.dart"
Cohesion: 0.20
Nodes (9): guru_dashboard_screen.dart, kelas_saya_screen.dart, build, createState, _index, routeName, _screens, profil_guru_screen.dart (+1 more)
...
### Community 45 - "State"
Cohesion: 0.32
Nodes (8): LoginScreen, _LoginScreenState, GuruDashboardScreen, _GuruDashboardScreenState, GuruHome, _GuruHomeState, State, StatefulWidget
...
Cohesion: 0.22
Nodes (8): EdgeInsetsGeometry, AppCard, build, child, onTap, padding, VoidCallback?, Widget?

### Community 48 - "empty_state.dart"
Cohesion: 0.22
Nodes (8): IconData, actionLabel, build, EmptyState, icon, message, onAction, title
...
## Knowledge Gaps
- **442 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+437 more)
