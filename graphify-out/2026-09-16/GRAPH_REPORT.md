# Graph Report - waoday  (2026-09-15)

## Corpus Check
- 105 files · ~65,073 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1195 nodes · 1529 edges · 79 communities (69 shown, 10 thin omitted)
...
### Community 17 - "State"
Cohesion: 0.25
Nodes (9): ManajemenSekolahScreen, _ManajemenSekolahScreenState, ManajemenAdminSekolahScreen, _ManajemenAdminSekolahScreenState, ManajemenSekolahScreen, _ManajemenSekolahScreenState, ManajemenSekolahScreen, State (+1 more)
...
Cohesion: 0.07
Nodes (30): buat_token_ujian_screen.dart, _buildMetricBox, _buildMiniChip, _buildNilaiSubBabTabContent, _buildRaporModalBody, _buildTokenInfoChip, createState, _currentKelas (+22 more)
...
Cohesion: 0.20
Nodes (9): auth_service.dart, ../config/api_config.dart, dart:io, GuruDashboardData, getDashboardData, GuruService, instance, ../models/guru_dashboard.dart (+1 more)

### Community 43 - "manajemen_admin_sekolah_screen.dart"
Cohesion: 0.08
Nodes (24): class, FormState, _admins, _adminService, build, _buildAdminCard, createState, didUpdateWidget (+16 more)

### Community 44 - "kelas_saya_screen.dart"
Cohesion: 0.18
Nodes (11): _apiKelasList, build, createState, _errorMessage, _handleRefresh, initState, _isLoading, KelasSayaScreen (+3 more)

### Community 45 - "guru_dashboard_screen.dart"
Cohesion: 0.15
Nodes (13): daftar_siswa_screen.dart, detail_kelas_screen.dart, build, createState, _errorMessage, _fetchDashboard, GuruDashboardScreen, _GuruDashboardScreenState (+5 more)
...
Cohesion: 0.08
Nodes (23): build, _buildSekolahCard, createState, _currentPage, dispose, _errorMessage, _handleDeleteSekolah, _hasMore (+15 more)
...
Cohesion: 0.67
Nodes (3): build, _openBuatToken, MaterialPageRoute
...
Cohesion: 0.14
Nodes (13): dart:convert, File, RaporNilaiSiswaResponse, RekapNilaiKelasResponse, downloadExportExcelToken, getNilaiSubBabKelas, getNilaiSubBabSiswa, _getToken (+5 more)
...
Cohesion: 0.15
Nodes (12): dart:async, createGameToken, GameTokenService, getMateri, getRekapNilai, _getToken, getTokensByKelas, instance (+4 more)
...
## Knowledge Gaps
- **762 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+757 more)
...
- **Why does `RekapNilaiKelasResponse` connect `nilai_sub_bab_service.dart` to `nilai_sub_bab.dart`, `detail_kelas_screen.dart`?**
