...
## Corpus Check
- 88 files · ~44,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 792 nodes · 1005 edges · 61 communities (52 shown, 9 thin omitted)
...
Cohesion: 0.06
Nodes (30): guru_dashboard_screen.dart, kelas_saya_screen.dart, AdminHome, build, routeName, build, createState, GuruHome (+22 more)
...
Cohesion: 0.06
Nodes (33): AdminDashboardScreen, _AdminDashboardScreenState, build, _buildStatCard, createState, _errorMessage, _fetchDashboardData, _guruList (+25 more)
...
Cohesion: 0.10
Nodes (19): build, createState, _currentPage, dispose, _errorMessage, _goToPage, _guruList, _handleDeleteGuru (+11 more)
...
### Community 45 - "State"
Cohesion: 0.40
Nodes (6): ManajemenGuruScreen, _ManajemenGuruScreenState, LoginScreen, _LoginScreenState, State, StatefulWidget
...
## Knowledge Gaps
- **451 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+446 more)
