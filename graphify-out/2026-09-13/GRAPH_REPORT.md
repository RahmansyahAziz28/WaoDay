...
## Corpus Check
- 100 files · ~56,273 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1021 nodes · 1307 edges · 73 communities (62 shown, 11 thin omitted)
...
Cohesion: 0.05
Nodes (41): ../admin/admin_home.dart, guru_dashboard_screen.dart, ../guru/guru_home.dart, kelas_saya_screen.dart, AdminHome, build, routeName, build (+33 more)
...
Cohesion: 0.06
Nodes (31): DateTime?, int get, _berlakuSampai, BuatTokenUjianScreen, _BuatTokenUjianScreenState, build, createState, dispose (+23 more)
...
Cohesion: 0.14
Nodes (14): buat_token_ujian_screen.dart, createState, _currentKelas, DetailKelasScreen, _DetailKelasScreenState, _errorMessage, _handleDeleteSiswa, initState (+6 more)
...
Cohesion: 0.09
Nodes (21): count, createdAt, SekolahInfo, data, fromJson, id, kelasList, kodeKelas (+13 more)
...
Cohesion: 0.07
Nodes (27): adminDetailUri, adminQueryUri, adminUri, ApiConfig, baseUrl, dashboardGuruEndpoint, dashboardGuruUri, gameTokenUri (+19 more)
...
Cohesion: 0.05
Nodes (41): AdminDashboardScreen, _AdminDashboardScreenState, build, _buildStatCard, createState, _errorMessage, _fetchDashboardData, _guruList (+33 more)
...
### Community 37 - "register_screen.dart"
Cohesion: 0.11
...
### Community 42 - "game_token_service.dart"
Cohesion: 0.12
Nodes (19): api_client.dart, auth_service.dart, ../config/api_config.dart, dart:async, dart:convert, dart:io, GuruDashboardData, createGameToken (+11 more)
...
Cohesion: 0.08
Nodes (25): FormState, build, _buildSekolahCard, createState, _currentPage, dispose, _errorMessage, _handleDeleteSekolah (+17 more)
...
Cohesion: 0.14
Nodes (13): AdminSekolah, _admins, allAdmins, createAdmin, deleteAdmin, getAdminList, _getToken, instance (+5 more)
...
Cohesion: 0.22
Nodes (8): admin_sekolah.dart, auth_user.dart, guru.dart, guru_dashboard.dart, kelas.dart, materi.dart, sekolah.dart, siswa.dart

## Knowledge Gaps
- **618 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+613 more)
