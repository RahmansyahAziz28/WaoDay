# Graph Report - waoday  (2026-09-03)

## Corpus Check
- 88 files · ~44,137 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 795 nodes · 1008 edges · 63 communities (54 shown, 9 thin omitted)
...
Cohesion: 0.11
Nodes (17): Guru, PaginatedGuruResponse, AdminService, createGuru, createSekolah, deleteGuru, deleteSekolah, getGuruDetail (+9 more)

### Community 35 - "manajemen_sekolah_screen.dart"
Cohesion: 0.12
Nodes (17): build, createState, dispose, _errorMessage, _handleDeleteSekolah, initState, _isLoading, _loadSekolah (+9 more)
...
Cohesion: 0.11
Nodes (18): build, createState, _currentPage, dispose, _errorMessage, _goToPage, _guruList, _handleDeleteGuru (+10 more)

### Community 39 - "auth_service.dart"
Cohesion: 0.12
Nodes (15): dart:async, AuthService, _clearSession, getToken, instance, _keyRefreshToken, _keyToken, _keyUser (+7 more)

### Community 40 - "admin_home.dart"
Cohesion: 0.22
Nodes (9): AdminHome, _AdminHomeState, build, createState, _index, routeName, manajemen_guru_screen.dart, profil_admin_screen.dart (+1 more)
...
Cohesion: 0.15
Nodes (12): auth_service.dart, ../config/api_config.dart, dart:convert, dart:io, GuruDashboardData, getDashboardData, GuruService, instance (+4 more)
...
Cohesion: 0.13
Nodes (14): build, _apiKelasList, build, createState, _errorMessage, _handleDeleteKelas, _handleRefresh, initState (+6 more)

### Community 45 - "State"
Cohesion: 0.27
Nodes (10): AdminDashboardScreen, _AdminDashboardScreenState, ManajemenGuruScreen, _ManajemenGuruScreenState, LoginScreen, _LoginScreenState, KelasSayaScreen, _KelasSayaScreenState (+2 more)
...
Cohesion: 0.20
Nodes (9): EdgeInsetsGeometry, AppCard, build, child, onLongPress, onTap, padding, VoidCallback? (+1 more)
...
## Knowledge Gaps
- **452 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+447 more)
