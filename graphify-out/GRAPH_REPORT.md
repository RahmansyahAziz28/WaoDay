...
## Corpus Check
- 102 files · ~58,774 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1078 nodes · 1378 edges · 80 communities (69 shown, 11 thin omitted)
...
Cohesion: 0.05
Nodes (38): DateTime?, int?, int get, deskripsi, fromJson, id, judulBab, mataPelajaran (+30 more)

### Community 9 - "register_screen.dart"
Cohesion: 0.05
Nodes (40): ApiResponse, AuthData, data, email, expiresAt, expiresIn, fromJson, id (+32 more)

### Community 10 - "../data/dummy_data.dart"
Cohesion: 0.21
Nodes (10): ../auth/login_screen.dart, ../data/dummy_data.dart, build, _handleLogout, build, _handleLogout, _handleRefresh, ../../services/auth_service.dart (+2 more)
...
Cohesion: 0.09
Nodes (21): count, createdAt, data, fromJson, Guru, id, kelasList, kodeKelas (+13 more)

### Community 30 - "guru_dashboard.dart"
Cohesion: 0.08
Nodes (24): alamat, createdAt, fromJson, GuruKelasItem, GuruProfil, GuruStatistik, id, kelas (+16 more)
...
Cohesion: 0.12
Nodes (16): PaginatedGuruResponse, AdminService, createGuru, createSekolah, deleteGuru, deleteSekolah, getGuruDetail, getGuruList (+8 more)

### Community 35 - "admin_dashboard_screen.dart"
Cohesion: 0.12
Nodes (16): AdminDashboardScreen, _AdminDashboardScreenState, build, _buildStatCard, createState, _errorMessage, _fetchDashboardData, _guruList (+8 more)
...
Cohesion: 0.18
Nodes (10): api_client.dart, auth_service.dart, ../config/api_config.dart, dart:io, GuruDashboardData, getDashboardData, GuruService, instance (+2 more)
...
Cohesion: 0.18
Nodes (11): build, createState, DaftarSiswaScreen, _DaftarSiswaScreenState, dispose, _handleDelete, kelas, _query (+3 more)
...
Cohesion: 0.14
Nodes (13): dart:convert, AdminSekolah, _admins, allAdmins, createAdmin, deleteAdmin, getAdminList, _getToken (+5 more)
...
### Community 69 - "StatefulWidget"
Cohesion: 0.40
Nodes (5): ManajemenGuruScreen, _ManajemenGuruScreenState, ManajemenSekolahScreen, ManajemenSekolahScreen, StatefulWidget
...
Cohesion: 0.12
Nodes (17): build, _buildBody, _buildStatCard, createState, _data, _errorMessage, _getRankBgColor, _getRankColor (+9 more)
...
Cohesion: 0.14
Nodes (13): RekapNilaiData, createGameToken, GameTokenService, getMateri, getRekapNilai, _getToken, getTokensByKelas, instance (+5 more)
...
### Community 79 - "static const"
Cohesion: 0.33
Nodes (5): AdminHome, build, routeName, manajemen_guru_screen.dart, static const

## Knowledge Gaps
- **666 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+661 more)
...
- **Why does `Kelas` connect `kelas.dart` to `buat_token_ujian_screen.dart`, `kelas_service.dart`, `daftar_siswa_screen.dart`, `detail_kelas_screen.dart`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `AuthData` connect `register_screen.dart` to `auth_service.dart`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `RekapNilaiData` connect `game_token_service.dart` to `game_token.dart`, `rekap_nilai_ujian_screen.dart`?**
