# Graph Report - waoday  (2026-09-08)

## Corpus Check
- 97 files · ~52,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 949 nodes · 1212 edges · 70 communities (59 shown, 11 thin omitted)
...
### Community 2 - "ChangeNotifier"
Cohesion: 0.67
Nodes (3): ChangeNotifier, AppData, AdminSekolahService

### Community 3 - "dummy_data.dart"
Cohesion: 0.09
Nodes (22): clearAuth, currentGuru, currentRole, currentUser, deleteSiswa, guruDashboardData, guruDashboardError, guruList (+14 more)

### Community 4 - "app_button.dart"
Cohesion: 0.18
Nodes (10): bool get, AppButtonVariant, build, fullWidth, icon, _isFilled, isLoading, label (+2 more)

### Community 5 - "forgot_password_screen.dart"
Cohesion: 0.05
...
Cohesion: 0.14
Nodes (14): build, createState, dispose, _emailController, _emailError, _errorMessage, _handleLogin, _isLoading (+6 more)

### Community 9 - "register_screen.dart"
Cohesion: 0.05
Nodes (41): int?, ApiResponse, AuthData, data, email, expiresAt, expiresIn, fromJson (+33 more)

### Community 10 - "../data/dummy_data.dart"
Cohesion: 0.24
Nodes (9): ../auth/login_screen.dart, ../data/dummy_data.dart, build, _handleLogout, build, _handleLogout, _handleRefresh, ../../services/auth_service.dart (+1 more)

### Community 11 - "api_client.dart"
Cohesion: 0.12
Nodes (15): Client, ApiClient, _buildHeaders, _client, defaultTimeout, delete, instance, post (+7 more)
...
Cohesion: 0.11
Nodes (17): alamat, count, createdAt, data, fromJson, id, limit, message (+9 more)

### Community 15 - "StatelessWidget"
Cohesion: 0.29
Nodes (7): AkademikApp, ProfilAdminScreen, _StatCard, ProfilGuruScreen, AppButton, AppInput, StatelessWidget
...
Cohesion: 0.17
Nodes (10): Color?, AppAvatar, backgroundColor, build, name, size, build, LoadingState (+2 more)

### Community 23 - "kelas_saya_screen.dart"
Cohesion: 0.07
Nodes (33): daftar_siswa_screen.dart, detail_kelas_screen.dart, _ManajemenSekolahScreenState, build, createState, _errorMessage, _fetchDashboard, GuruDashboardScreen (+25 more)
...
Cohesion: 0.08
Nodes (25): adminDetailUri, adminQueryUri, adminUri, ApiConfig, baseUrl, dashboardGuruEndpoint, dashboardGuruUri, guruBaseUri (+17 more)
...
Cohesion: 0.11
Nodes (17): AuthService, _clearSession, getToken, handleSessionExpired, instance, _isHandlingSessionExpired, _keyRefreshToken, _keyToken (+9 more)

### Community 40 - "admin/manajemen_sekolah_screen.dart"
Cohesion: 0.13
...
Cohesion: 0.18
Nodes (10): auth_service.dart, ../config/api_config.dart, dart:convert, dart:io, GuruDashboardData, getDashboardData, GuruService, instance (+2 more)
...
Cohesion: 0.22
Nodes (8): EdgeInsetsGeometry, AppCard, build, child, onLongPress, onTap, padding, Widget?

### Community 48 - "empty_state.dart"
Cohesion: 0.22
Nodes (8): actionLabel, build, EmptyState, icon, message, onAction, title, VoidCallback?
...
Cohesion: 0.17
Nodes (10): GlobalKey, AdminHome, build, routeName, appMessengerKey, appNavigatorKey, manajemen_guru_screen.dart, NavigatorState (+2 more)
...
Cohesion: 0.12
Nodes (15): AdminSekolah, copyWith, createdAt, email, fromJson, id, isActive, nama (+7 more)

### Community 66 - "admin_sekolah_service.dart"
Cohesion: 0.14
Nodes (13): api_client.dart, dart:async, _admins, allAdmins, createAdmin, deleteAdmin, getAdminList, _getToken (+5 more)

### Community 67 - "kelas.dart"
Cohesion: 0.15
Nodes (12): daftarSiswa, fromJson, guruId, guruPengampu, id, jumlahSiswa, kodeKelas, namaKelas (+4 more)

### Community 68 - "superadmin_home.dart"
Cohesion: 0.17
...
### Community 69 - "splash_screen.dart"
Cohesion: 0.14
Nodes (14): ../admin/admin_home.dart, ../guru/guru_home.dart, ManajemenSekolahScreen, build, _checkAuth, createState, initState, routeName (+6 more)

### Community 70 - "models.dart"
Cohesion: 0.25
Nodes (7): admin_sekolah.dart, auth_user.dart, guru.dart, guru_dashboard.dart, kelas.dart, sekolah.dart, siswa.dart

## Knowledge Gaps
- **560 isolated node(s):** `ApiConfig`, `baseUrl`, `loginEndpoint`, `logoutEndpoint`, `dashboardGuruEndpoint` (+555 more)
...
- **Why does `AdminSekolah` connect `admin_sekolah.dart` to `admin_sekolah_service.dart`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AuthData` connect `register_screen.dart` to `auth_service.dart`?**
